...
import { faFacebook, faGithub, faInstagram, faLinkedin, faPython, faWhatsapp } from '@fortawesome/free-brands-svg-icons'
import './Home.css'
import Navbar from '../../components/Navbar'
const Home = () => {

  let imgRef = useRef()
  let pythonLogo = useRef()
  let hireRef = useRef()
  ...
  return (
    <div>
      <Navbar imgref={imgRef} pythonLogo={pythonLogo} hireRef={hireRef} ptitleRef={ptitleRef} pimgRef={pimgRef} animRef={animRef} />
          ...
          <div className=" col-lg-5 col-md-6 col-sm-12 col-12 profile-title " ref={ptitleRef}>
            <div className=" name-div ms-5 ps-5 text-white">
              <span className='display-3 react-icon'>
                <FontAwesomeIcon icon={faPython} ref={pythonLogo} className='react-logo ' /></span>
              ...
              <marquee behavior="" direction="right">
                <p className=' frontend text-white '>python-web-developer </p>
              </marquee>
