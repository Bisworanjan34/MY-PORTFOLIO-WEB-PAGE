...
const Details = () => {
  return (
    <div className='details-div'>
      ...
      <p className='tpurple'>i am a Skilled python-Web-Developer specializing in building
      ...
      <ul className='skill-list'>
        ...
        <li><b>Backend</b> -: python,django,django-rest-framework,jwt-token </li>
        <li><b>Database</b>-: sql,sqllite,postgresql,mysql</li>
        <li><b>Tools</b>   -: vscode,github,vite,pycharm </li>
